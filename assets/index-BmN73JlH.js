...
\f\r"'\`<>=]|("|')|))|$)`,"g"),G=/'/g,Y=/"/g,se=/^(?:script|style|textarea|title)$/i,ve=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),c=ve(1),_=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Q=new WeakMap,v=b.createTreeWalker(b,129);function ie(r,e){if(!B(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Z!==void 0?Z.createHTML(e):e}const be=(r,e)=>{const t=r.length-1,s=[];let i,n=e===2?"<svg>":e===3?"<math>":"",o=A;for(let l=0;l<t;l++){const a=r[l];let d,u,h=-1,m=0;for(;m<a.length&&(o.lastIndex=m,u=o.exec(a),u!==null);)m=o.lastIndex,o===A?u[1]==="!--"?o=K:u[1]!==void 0?o=J:u[2]!==void 0?(se.test(u[2])&&(i=RegExp("</"+u[2],"g")),o=$):u[3]!==void 0&&(o=$):o===$?u[0]===">"?(o=i??A,h=-1):u[1]===void 0?h=-2:(h=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?$:u[3]==='"'?Y:G):o===Y||o===G?o=$:o===K||o===J?o=A:(o=$,i=void 0);const g=o===$&&r[l+1].startsWith("/>")?" ":"";n+=o===A?a+fe:h>=0?(s.push(d),a.slice(0,h)+ee+a.slice(h)+f+g):a+f+(h===-2?l:g)}return[ie(r,n+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class P{constructor({strings:e,_$litType$:t},s){let i;this.parts=[];let n=0,o=0;const l=e.length-1,a=this.parts,[d,u]=be(e,t);if(this.el=P.createElement(d,s),v.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(i=v.nextNode())!==null&&a.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(const h of i.getAttributeNames())if(h.endsWith(ee)){const m=u[o++],g=i.getAttribute(h).split(f),M=/([.?@])?(.*)/.exec(m);a.push({type:1,index:n,name:M[2],strings:g,ctor:M[1]==="."?_e:M[1]==="?"?we:M[1]==="@"?Ae:R}),i.removeAttribute(h)}else h.startsWith(f)&&(a.push({type:6,index:n}),i.removeAttribute(h));if(se.test(i.tagName)){const h=i.textContent.split(f),m=h.length-1;if(m>0){i.textContent=H?H.emptyScript:"";for(let g=0;g<m;g++)i.append(h[g],S()),v.nextNode(),a.push({type:2,index:++n});i.append(h[m],S())}}}else if(i.nodeType===8)if(i.data===te)a.push({type:2,index:n});else{let h=-1;for(;(h=i.data.indexOf(f,h+1))!==-1;)a.push({type:7,index:n}),h+=f.length-1}n++}}static createElement(e,t){const s=b.createElement("template");return s.innerHTML=e,s}}function w(r,e,t=r,s){if(e===_)return e;let i=s!==void 0?t._$Co?.[s]:t._$Cl;const n=E(e)?void 0:e._$litDirective$;return i?.constructor!==n&&(i?._$AO?.(!1),n===void 0?i=void 0:(i=new n(r),i._$AT(r,t,s)),s!==void 0?(t._$Co??=[])[s]=i:t._$Cl=i),i!==void 0&&(e=w(r,i._$AS(r,e.values),i,s)),e}class ye{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:s}=this._$AD,i=(e?.creationScope??b).importNode(t,!0);v.currentNode=i;let n=v.nextNode(),o=0,l=0,a=s[0];for(;a!==void 0;){if(o===a.index){let d;a.type===2?d=new C(n,n.nextSibling,this,e):a.type===1?d=new a.ctor(n,a.name,a.strings,this,e):a.type===6&&(d=new xe(n,this,e)),this._$AV.push(d),a=s[++l]}o!==a?.index&&(n=v.nextNode(),o++)}return v.currentNode=b,i}p(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class C{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,s,i){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=w(this,e,t),E(e)?e===p||e==null||e===""?(this._$AH!==p&&this._$AR(),this._$AH=p):e!==this._$AH&&e!==_&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):$e(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==p&&E(this._$AH)?this._$AA.nextSibling.data=e:this.T(b.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:s}=e,i=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=P.createElement(ie(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(t);else{const n=new ye(i,this),o=n.u(this.options);n.p(t),this.T(o),this._$AH=n}}_$AC(e){let t=Q.get(e.strings);return t===void 0&&Q.set(e.strings,t=new P(e)),t}k(e){B(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,i=0;for(const n of e)i===t.length?t.push(s=new C(this.O(S()),this.O(S()),this,this.options)):s=t[i],s._$AI(n),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const s=e.nextSibling;e.remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class R{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,s,i,n){this.type=1,this._$AH=p,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=p}_$AI(e,t=this,s,i){const n=this.strings;let o=!1;if(n===void 0)e=w(this,e,t,0),o=!E(e)||e!==this._$AH&&e!==_,o&&(this._$AH=e);else{const l=e;let a,d;for(e=n[0],a=0;a<n.length-1;a++)d=w(this,l[s+a],t,a),d===_&&(d=this._$AH[a]),o||=!E(d)||d!==this._$AH[a],d===p?e=p:e!==p&&(e+=(d??"")+n[a+1]),this._$AH[a]=d}o&&!i&&this.j(e)}j(e){e===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class _e extends R{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===p?void 0:e}}class we extends R{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==p)}}class Ae extends R{constructor(e,t,s,i,n){super(e,t,s,i,n),this.type=5}_$AI(e,t=this){if((e=w(this,e,t,0)??p)===_)return;const s=this._$AH,i=e===p&&s!==p||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,n=e!==p&&(s===p||i);i&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class xe{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){w(this,e)}}const ke=D.litHtmlPolyfillSupport;ke?.(P,C),(D.litHtmlVersions??=[]).push("3.3.1");const Se=(r,e,t)=>{const s=t?.renderBefore??e;let i=s._$litPart$;if(i===void 0){const n=t?.renderBefore??null;s._$litPart$=i=new C(e.insertBefore(S(),n),n,void 0,t??{})}return i._$AI(r),i};const z=globalThis;class k extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Se(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _}}k._$litElement$=!0,k.finalized=!0,z.litElementHydrateSupport?.({LitElement:k});const Ee=z.litElementPolyfillSupport;Ee?.({LitElement:k});(z.litElementVersions??=[]).push("4.2.1");const Pe=r=>(e,t)=>{t!==void 0?t.addInitializer((()=>{customElements.define(r,e)})):customElements.define(r,e)};const Ce={attribute:!0,type:String,converter:O,reflect:!1,hasChanged:L},Me=(r=Ce,e,t)=>{const{kind:s,metadata:i}=t;let n=globalThis.litPropertyMetadata.get(i);if(n===void 0&&globalThis.litPropertyMetadata.set(i,n=new Map),s==="setter"&&((r=Object.create(r)).wrapped=!0),n.set(t.name,r),s==="accessor"){const{name:o}=t;return{set(l){const a=e.get.call(this);e.set.call(this,l),this.requestUpdate(o,a,r)},init(l){return l!==void 0&&this.C(o,void 0,r,l),l}}}if(s==="setter"){const{name:o}=t;return function(l){const a=this[o];e.call(this,l),this.requestUpdate(o,a,r)}}throw Error("Unsupported decorator location: "+s)};function Te(r){return(e,t)=>typeof t=="object"?Me(r,e,t):((s,i,n)=>{const o=i.hasOwnProperty(n);return i.constructor.createProperty(n,s),o?Object.getOwnPropertyDescriptor(i,n):void 0})(r,e,t)}function Oe(r){return Te({...r,state:!0,attribute:!1})}var He=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,re=(r,e,t,s)=>{for(var i=s>1?void 0:s?Ue(e,t):e,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=(s?o(e,t,i):o(i))||i);return s&&i&&He(e,t,i),i};let N=class extends k{constructor(){super(...arguments),this.themeMode="system",this.fullName="William Perkola",this.jobTitle="Product owner & Software Engineer",this.email="hej@perko.la",this.location="Stockholm, Sweden",this.linkedin="linkedin.com/in/perkola",this.github="github.com/perkola",this.experience=[{company:"OSTTRA",positions:[{title:"Senior Software Developer",period:"2021 - Present",description:["Managing an inner sourced design system at OSTTRA through a tight collaboration with product teams and the UX department.","Engaging stakeholders, prioritizing work, managing quality and maintaining source code.","Currently driving adoption across 20+ product teams at OSTTRA."],skills:["Project management","React","TypeScript","Storybook","Figma"]},{title:"Software Engineer",period:"2017 - 2023",description:["Full-stack role in a highly autonomous and experienced team, building a collateral management system and a settlement service using micro services on a private cloud infrastructure."],skills:["Go","Python","Clojure","ClojureScript","Docker","Kubernetes"]}]},{company:"Freelance",positions:[{title:"Software Consultant",period:"2015 - 2021",description:["Working with mainly non-profit organizations designing, building and maintaining websites and digital payment systems."],skills:["PHP","SQL","JavaScript"]}]},{company:"Scania Group",positions:[{title:"Master Thesis Student",period:"2017 - 2017",description:["Using machine learning, at the C-ITS (Cooperative Intelligent Transport System) R&D department, to classify short-lived distributed hazard warning messages to road vehicles."],skills:["Python","Machine Learning"]},{title:"Intern",period:"2016 - 2017",description:["A year long internship programme at the R&D department for master's students."]},{title:"Mobile Developer",period:"2016 - 2016",description:["Building a prototype for a map-based mobile application in a research project at the R&D department."],skills:["Android","React Native","C#","Microsoft Azure"]}]},{company:"Academic Work",positions:[{title:"Software Consultant",period:"2014 - 2015",description:["Part time consultancy at an advertising company. Responsibilities consisted of maintaining multiple websites while developing a job search engine using the API of the Swedish Public Employment Service (Arbetsförmedlningen)."],skills:["PHP","JavaScript","HTML","CSS"]}]}],this.education=[{degree:"Master of Engineering (M.Eng.), Computer Science",institution:"KTH Royal Institute of Technology",period:"2015 - 2017"},{degree:"Bachelor of Engineering (B.Eng.), Computer Science",institution:"KTH Royal Institute of Technology",period:"2012 - 2015"}],this.cycleTheme=()=>{const r=["light","system","dark"],e=r.indexOf(this.themeMode);this.themeMode=r[(e+1)%r.length],this.saveThemePreference(),this.applyTheme(),this.requestUpdate()}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.loadThemePreference(),this.applyTheme(),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{this.themeMode==="system"&&this.applyTheme()})}loadThemePreference(){const r=localStorage.getItem("theme-mode");r&&["light","dark","system"].includes(r)&&(this.themeMode=r)}saveThemePreference(){localStorage.setItem("theme-mode",this.themeMode)}applyTheme(){const r=document.documentElement;this.themeMode==="dark"||this.themeMode==="system"&&window.matchMedia("(prefers-color-scheme: dark)").matches?r.classList.add("dark"):r.classList.remove("dark")}render(){return c`
    ...
    `}getIcon(r){return{sun:c`<svg
      ...
      >
        ...
        />
      </svg>`}[r]}renderHeader(){const r={light:this.getIcon("sun"),dark:this.getIcon("moon"),system:this.getIcon("computer")};return c`
      <div
